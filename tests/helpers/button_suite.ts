...
import * as schemaModule from '@/function/schema';
...
type MvuData = any;
type ButtonTestOptions = { mvuZod?: boolean };
const { EXTENSIBLE_MARKER } = schemaModule;
...
const reconcileAndApplySchemaSpy = jest.spyOn(schemaModule, 'reconcileAndApplySchema');
const cleanUpMetadataSpy = jest.spyOn(schemaModule, 'cleanUpMetadata');
...
export function registerButtonTests({ mvuZod = false }: ButtonTestOptions = {}): void {
    ...
    describe('reloadInit function', () => {
        ...
        describe('Basic error handling', () => {
            ...
            test('should handle no message found', async () => {
                ...
                expect(toastr.error).toHaveBeenCalledWith('没有找到消息', '[MVU]', {
                    timeOut: 3000,
                });
    ...
    describe('RecurVariable function', () => {
        ...
        nativeTest('should replay variable updates from the selected floor', async () => {
