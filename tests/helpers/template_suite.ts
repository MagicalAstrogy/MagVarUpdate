...
type MvuData = any;
type TemplateTestOptions = { mvuZod?: boolean };

export function registerTemplateTests({ mvuZod = false }: TemplateTestOptions = {}): void {
    const nativeIt = mvuZod ? it.skip : it;
    describe('Template Feature', () => {
        ...
        describe('Integration with assign/insert operations', () => {
            ...
            nativeIt('should apply template when assigning to array (2 args)', async () => {
                // 设置带模板的数组
                variables.stat_data = {
                    items: [
                        { name: 'existing' },
            ...
            nativeIt(
                ...
                async () => {
                    ...
                    expect(
                        (variables.schema as any).properties.root.properties.new_node.extensible
                    ).toBe(true);
                    expect(rootData.new_node).toEqual({ owo: 123, tvt: '234' });
                    expect((rootData.new_node as any).$meta).toBeUndefined();
                }
            ...
            nativeIt(
                ...
                async () => {
                    ...
                    expect(
                        (variables.schema as any).properties.root.properties.new_node.properties
                            .items.extensible
                    ).toBe(true);
                    expect(
                        (variables.schema as any).properties.root.properties.new_node.properties
            ...
            nativeIt('should handle type mismatch between template and value', async () => {
                variables.stat_data = {
                    items: [],
                };
                variables.schema = {
        ...
        describe('Edge cases and special scenarios', () => {
            ...
            it('should NOT remove $meta from template when cleaning up metadata', () => {
                ...
                if (
                    ...
                    expect(schema.template.$meta).toBeDefined();
                    expect(schema.template.$meta).toEqual({
                        extensible: false,
                        required: ['name'],
                    });
                }
            ...
            nativeIt('should apply any[] template in array assign operation', async () => {
            ...
            nativeIt('should apply literal-to-array-template in assign operation', async () => {
                const variables: MvuData = {
                    initialized_lorebooks: {},
                    stat_data: {
                        skills: [],
        ...
        describe('Missing test cases from issue #22', () => {
            ...
            nativeIt('should validate extensible property for arrays', async () => {
            ...
            nativeIt('should validate extensible property for objects', async () => {
            ...
            nativeIt('should handle template with primitive array correctly', async () => {
                // 测试原始类型数组作为模板
                variables.stat_data = {
                    tags: [],
                };
            ...
            nativeIt('should handle Date objects in templates', async () => {
                // 测试模板中的日期对象处理
            ...
            nativeIt('should handle complex nested template application', async () => {
                // 复杂嵌套场景
                variables.stat_data = {
                    game: {
                        levels: [
        ...
        describe('3-parameter array template scenarios', () => {
            ...
            nativeIt('should handle type mismatch when assigning object to array with template (3 params)', async () => {
            ...
            nativeIt('should merge array template with array value (3 params)', async () => {
        ...
        describe('Feature Switches - Non-default Combinations', () => {
            ...
            describe('strictTemplate=false, concatTemplateArray=false', () => {
                nativeIt('should allow primitive conversion with merge behavior', async () => {
                    const variables: MvuData = {
                        initialized_lorebooks: {},
                        stat_data: { items: [] },
                        display_data: {},
                ...
                nativeIt('should merge arrays by position', async () => {
                    const variables: MvuData = {
                        initialized_lorebooks: {},
                        stat_data: { data: [] },
                        display_data: {},
            ...
            describe('strictTemplate=true, concatTemplateArray=false', () => {
                nativeIt('should prevent conversion and use merge for arrays', async () => {
                    const variables: MvuData = {
                        initialized_lorebooks: {},
                        stat_data: { items: [] },
                        display_data: {},
                ...
                nativeIt(
                    'should prevent conversion and use merge for arrays(from $meta)',
                    async () => {
                        const variables: MvuData = {
                            initialized_lorebooks: {},
                            stat_data: {
                ...
                nativeIt('should handle nested operations with both switches', async () => {
                    const variables: MvuData = {
                        initialized_lorebooks: {},
                        stat_data: {
                            $meta: {
                    ...
                    expect((variables.stat_data.container as any).list).toEqual([
                        ['nested', 'y', 'z'],
                    ]);
                });
            });
